  ...
  render() {
    return (
      <Container
        ...
        <Link className="frontpage-grid-item" to="/uskomaton-elama">
          <Item handleImageLoad={this.handleImageLoad} src={uskomatonElama} />
        </Link>
        <a href="http://www.kotkaniemi.fi" className="frontpage-grid-item">
          <Item handleImageLoad={this.handleImageLoad} src={kk} />
        </a>
        <Link className="frontpage-grid-item" to="/info">
          <Item handleImageLoad={this.handleImageLoad} src={perinto} />
        </Link>
        <Link className="frontpage-grid-item" to="/feature">
          <Item
            handleImageLoad={this.handleImageLoad}
            src={svinhufvudLakimiehena}
          />
        </Link>
      </Container>
    );
